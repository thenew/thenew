...
zoombox = {
	...
	duration:		420,		// Animation duration (ms)
	...
	theme:		"thenewbox", 			// Define the theme to use
	 ...
	 *	#zoombox_title h3		=> Title of the link will be displayed here
	...
	themes:{
						...
						<div id="zoombox_nav">\
							<table>\
								<tr>\
									...
									<td><div id="zoombox_title"><h3></h3></div></td>\
			...
			<div id="zoombox" class="lightbox"> \
				...
				<div id="zoombox_contener">\
					<div id="zoombox_relative">\
						<div id="zoombox_content"></div>\
						<div id="zoombox_bg"><div class="zoombox_bg_h"></div><div class="zoombox_bg_b"></div><div class="zoombox_bg_d"></div><div class="zoombox_bg_g"></div><div class="zoombox_bg_bg"></div><div class="zoombox_bg_bd"></div><div class="zoombox_bg_hg"></div><div class="zoombox_bg_hd"></div></div>\
						<div id="zoombox_infos"<div id="zoombox_title"><h3></h3></div></div>\
						<div id="zoombox_close" class="zoombox_close"></div>\
		...
		"thenewbox" :	 '\
			<div id="zoombox"> \
				...
				<div id="zoombox_contener">\
					<div id="zoombox_relative">\
						<div id="zoombox_close" class="zoombox_close">x</div>\
						<!--[if IE]><div id="zoombox_content"></div><![endif]-->\
						<!--[if !IE]> <--><figure id="zoombox_content"></figure><!--><![endif]-->\
						<div id="zoombox_title" class="zoombox_close"><h3></h3></div>\
					</div>\
				</div>\
			</div>\
			'
	...
	open : function(url,width,height){
		...
		if(zoombox.title && zoombox.title!="" && zoombox.title!=null){ $("#zoombox_title h3").append(zoombox.title); $("#zoombox_title").show();   }  // Do we have a title ?
