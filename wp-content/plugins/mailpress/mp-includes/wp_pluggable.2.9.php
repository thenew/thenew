...
function wp_new_user_notification($user_id, $plaintext_pass = '') {
	...
	$message  = sprintf(__('New user registration on your blog %s:'), $blogname) . "<br />\r\n<br />\r\n";
...
function mp_retrieve_password_message($message, $key)
{
	...
	$url_reset  = site_url("wp-login.php?action=rp&key=$key&login=" . rawurlencode($user_login), 'login');
