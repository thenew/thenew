...
////  Object  ////
	...
	{
		$object_id = (int) $object_id;
		if (!is_array($object_terms) || 0 == count($object_terms) || empty($object_terms)) $object_terms = array(get_option(MailPress_mailinglist::option_name_default));
