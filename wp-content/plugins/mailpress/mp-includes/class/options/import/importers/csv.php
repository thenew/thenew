...
<?php MP_AdminPage::select_option($draft_dest, 'MailPress_mailinglist~' . get_option(MailPress_mailinglist::option_name_default)) ?>
		</select>
<?php endif; ?>
<?php if (class_exists('MailPress_newsletter')) : ?>
		...
		<p>
			...
			<?php _e('If subscriber already exists, <b>add</b> default subscriptions.', MP_TXTDOM); ?>
		</p>
<?php endif; ?>
