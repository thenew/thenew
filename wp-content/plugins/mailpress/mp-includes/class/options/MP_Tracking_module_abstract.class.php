<?php
abstract class MP_Tracking_module_abstract
{
	...
	function register($modules, $type)
	{
		...
		$modules[$this->module]['title'] = $this->title;
		if (isset($this->parms)) $modules[$this->module]['parms'] = $this->parms;
		return $modules;
	}

	function add_meta_box($screen)
	{
		add_meta_box('tracking' . $this->module . 'div', $this->title, array(&$this, 'meta_box'), $screen, $this->context, '');
	}
}