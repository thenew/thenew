...
/*
	...
	Modified by James Lao to support file type specification.
	...
	ft: file type (jpg, png, gif, default is jpg)
...
if(strlen($src) && file_exists($src)) {
	...
	show_image($canvas, $cache_dir, $file_type);
 ...
 * 
 */
function show_image($image_resized, $cache_dir, $file_type = "jpg") {
	...
	if(@touch($cache_file_name)) {
		...
		// If no cache, send correct mime type header.
